...
// --- HOOKS PERSONALIZADOS PARA EL EFECTO "WOW" ---

// 1. Contador animado para las métricas
...
// 2. Efecto de Máquina de Escribir para la IA
...
// 3. Fracciones Matemáticas exactas
...
export default function SimuladorUltraPro() {
  ...
  const ejecutarSimulacion = async () => {
    ...
    try {
      ...
      alert("⚠️ Error de conexión con el motor Python. Chequeá que el backend esté corriendo.");
    }
    setLoading(false);
  };
  ...
  const ahorro = results && results.promedio_teorico > 0 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <main className="lg:col-span-9">
            ...
            <div className="relative min-h-[600px]">
                ...
                !hasSimulated ? (
                  ...
                  <div className="animate-in slide-in-from-bottom-8 fade-in duration-1000 space-y-8">
                    ...
                    <Grid numItemsMd={3} className="gap-6">
                      {[
                        { title: "Promedio Simulado", value: countSimulado, raw: results.promedio_simulado, icon: Package, color: "blue", sub: `Con ${amigos} amigos` },
                        { title: "Valor Teórico", value: countTeorico, raw: results.promedio_teorico, icon: Calculator, color: "yellow", sub: "Matemática Pura" },
              ...
              {/* PESTAÑA 1: TEORÍA (TEXTO RESTAURADO EXACTAMENTE AL ORIGINAL DE STREAMLIT) */}
              {!loading && activeTab === 1 && (
